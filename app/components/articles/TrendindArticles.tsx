...
export default function TrendingArticles() {
  return (
    <section className="max-w-6xl mx-auto px-6 py-12 font-sans">
      ...
      <div className="mb-2">
        <div className="inline-flex items-center gap-1.5 bg-(--color-emerald-light) border border-(--color-emerald-light) rounded-full px-3 py-1 mb-6">
      ...
      <h2 className="text-3xl sm:text-6xl font-bold text-(--color-black) mb-8">
      ...
      <div className="divide-y divide-(--color-gray-light)">
